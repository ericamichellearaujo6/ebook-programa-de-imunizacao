...
function scene:create(event)
    ...
    local bg = display.newImageRect(sceneGroup, "assets/info_eficacia.png", 768, 1024)
    bg.x = centerX
    bg.y = centerY 
    ...
    local function showImage()
        ...
        local image = display.newImage(sceneGroup, "assets/explicacao3.png")
    ...
    local btShowRect = createButton(
        sceneGroup,
        "assets/resposta3.png",  -- Imagem do botão para exibir a retângulo
        centerX + 200, 
        centerY - 250, 
        1.0, 
        1.0, 
